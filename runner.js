...
function start() {
	if(--counter === 0) {
		showMsg(
			'<h1>POWERED BY:- </h1>'+
            '<h3> MANISH KUMAR MANDAL</h3>' +
			'<br>'+

			'<br>'+

			'<h3>TOUCH THE DISPLAY  &  CLICK THE MOUSE....</h3>'+
			...
			'Manish zelo rada pleza. Zaradi slabega vremena ali zaradi premalo časa pa ne more vsak dan v hribe. '  +
			...
			'<br>' +
			'<br><br><b>Pritisni za plezanje: <br>'+

		
			

			goalName + '(' + goalDistance + 'm)</b>'
		);
		initialized = true;
	}
}
